...
class Board(object):
    ...
    def __init__(self):
        ...
        self.wins = [self.positions[(r, 0)] | self.positions[(r, 1)] | self.positions[(r, 2)] for r in range(3)] +\
                    [self.positions[(0, c)] | self.positions[(1, c)] | self.positions[(2, c)]for c in range(3)] +\
